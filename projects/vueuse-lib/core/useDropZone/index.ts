...
export interface UseDropZoneOptions {
   ...
   */
  dataTypes?: MaybeRefOrGetter<readonly string[]> | ((types: readonly string[]) => boolean);
  /**
...
export function useDropZone(
  ...
  if (isClient) {
    ...
    const checkDataTypes = (types: string[]) => {
      const dataTypes = toValue(
        _options.dataTypes as
          | MaybeRefOrGetter<readonly string[] | ((types: readonly string[]) => boolean)>
          | undefined,
      );
